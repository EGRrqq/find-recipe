...
export const imageData: IImageData[] = [
    ...
    {
        label: 'random label _$@975&',
        image: 'https://d33wubrfki0l68.cloudfront.net/49de349d12db851952c5556f3c637ca772745316/cfc56/static/images/wallpapers/bridge-02@2x.png',
    },
    {
        label: 'random label =$@%128_',
